...
local vehicleSeat = workspace:WaitForChild(player.Name.."'s VioletCar"):WaitForChild("Base"):WaitForChild("VehicleSeat")

local motorFR = workspace:WaitForChild(player.Name.."'s VioletCar").WheelFR:FindFirstChildWhichIsA("CylindricalConstraint", true)
local motorFL = workspace:WaitForChild(player.Name.."'s VioletCar").WheelFL:FindFirstChildWhichIsA("CylindricalConstraint", true)
local motorBR = workspace:WaitForChild(player.Name.."'s VioletCar").WheelBR:FindFirstChildWhichIsA("CylindricalConstraint", true)
local motorBL = workspace:WaitForChild(player.Name.."'s VioletCar").WheelBL:FindFirstChildWhichIsA("CylindricalConstraint", true)

local springFR = workspace:WaitForChild(player.Name.."'s VioletCar").WheelFR:FindFirstChildWhichIsA("SpringConstraint", true)
local springFL = workspace:WaitForChild(player.Name.."'s VioletCar").WheelFL:FindFirstChildWhichIsA("SpringConstraint", true)
local springBR = workspace:WaitForChild(player.Name.."'s VioletCar").WheelBR:FindFirstChildWhichIsA("SpringConstraint", true)
local springBL = workspace:WaitForChild(player.Name.."'s VioletCar").WheelBL:FindFirstChildWhichIsA("SpringConstraint", true)

local wheelHingeR = workspace:WaitForChild(player.Name.."'s VioletCar").WheelFR:FindFirstChildWhichIsA("HingeConstraint", true)
local wheelHingeL = workspace:WaitForChild(player.Name.."'s VioletCar").WheelFL:FindFirstChildWhichIsA("HingeConstraint", true)
