...
local vehicleSeat = workspace:WaitForChild(player.Name.."'s YellowCar"):WaitForChild("Base"):WaitForChild("VehicleSeat")

local motorFR = workspace:WaitForChild(player.Name.."'s YellowCar").WheelFR:FindFirstChildWhichIsA("CylindricalConstraint", true)
local motorFL = workspace:WaitForChild(player.Name.."'s YellowCar").WheelFL:FindFirstChildWhichIsA("CylindricalConstraint", true)
local motorBR = workspace:WaitForChild(player.Name.."'s YellowCar").WheelBR:FindFirstChildWhichIsA("CylindricalConstraint", true)
local motorBL = workspace:WaitForChild(player.Name.."'s YellowCar").WheelBL:FindFirstChildWhichIsA("CylindricalConstraint", true)

local springFR = workspace:WaitForChild(player.Name.."'s YellowCar").WheelFR:FindFirstChildWhichIsA("SpringConstraint", true)
local springFL = workspace:WaitForChild(player.Name.."'s YellowCar").WheelFL:FindFirstChildWhichIsA("SpringConstraint", true)
local springBR = workspace:WaitForChild(player.Name.."'s YellowCar").WheelBR:FindFirstChildWhichIsA("SpringConstraint", true)
local springBL = workspace:WaitForChild(player.Name.."'s YellowCar").WheelBL:FindFirstChildWhichIsA("SpringConstraint", true)

local wheelHingeR = workspace:WaitForChild(player.Name.."'s YellowCar").WheelFR:FindFirstChildWhichIsA("HingeConstraint", true)
local wheelHingeL = workspace:WaitForChild(player.Name.."'s YellowCar").WheelFL:FindFirstChildWhichIsA("HingeConstraint", true)
