...
local vehicleSeat = workspace:WaitForChild(player.Name.."'s RedCar"):WaitForChild("Base"):WaitForChild("VehicleSeat")

local motorFR = workspace:WaitForChild(player.Name.."'s RedCar").WheelFR:FindFirstChildWhichIsA("CylindricalConstraint", true)
local motorFL = workspace:WaitForChild(player.Name.."'s RedCar").WheelFL:FindFirstChildWhichIsA("CylindricalConstraint", true)
local motorBR = workspace:WaitForChild(player.Name.."'s RedCar").WheelBR:FindFirstChildWhichIsA("CylindricalConstraint", true)
local motorBL = workspace:WaitForChild(player.Name.."'s RedCar").WheelBL:FindFirstChildWhichIsA("CylindricalConstraint", true)

local springFR = workspace:WaitForChild(player.Name.."'s RedCar").WheelFR:FindFirstChildWhichIsA("SpringConstraint", true)
local springFL = workspace:WaitForChild(player.Name.."'s RedCar").WheelFL:FindFirstChildWhichIsA("SpringConstraint", true)
local springBR = workspace:WaitForChild(player.Name.."'s RedCar").WheelBR:FindFirstChildWhichIsA("SpringConstraint", true)
local springBL = workspace:WaitForChild(player.Name.."'s RedCar").WheelBL:FindFirstChildWhichIsA("SpringConstraint", true)

local wheelHingeR = workspace:WaitForChild(player.Name.."'s RedCar").WheelFR:FindFirstChildWhichIsA("HingeConstraint", true)
local wheelHingeL = workspace:WaitForChild(player.Name.."'s RedCar").WheelFL:FindFirstChildWhichIsA("HingeConstraint", true)
