...
local vehicleSeat = workspace:WaitForChild(player.Name.."'s BlueCar"):WaitForChild("Base"):WaitForChild("VehicleSeat")

local motorFR = workspace:WaitForChild(player.Name.."'s BlueCar").WheelFR:FindFirstChildWhichIsA("CylindricalConstraint", true)
local motorFL = workspace:WaitForChild(player.Name.."'s BlueCar").WheelFL:FindFirstChildWhichIsA("CylindricalConstraint", true)
local motorBR = workspace:WaitForChild(player.Name.."'s BlueCar").WheelBR:FindFirstChildWhichIsA("CylindricalConstraint", true)
local motorBL = workspace:WaitForChild(player.Name.."'s BlueCar").WheelBL:FindFirstChildWhichIsA("CylindricalConstraint", true)

local springFR = workspace:WaitForChild(player.Name.."'s BlueCar").WheelFR:FindFirstChildWhichIsA("SpringConstraint", true)
local springFL = workspace:WaitForChild(player.Name.."'s BlueCar").WheelFL:FindFirstChildWhichIsA("SpringConstraint", true)
local springBR = workspace:WaitForChild(player.Name.."'s BlueCar").WheelBR:FindFirstChildWhichIsA("SpringConstraint", true)
local springBL = workspace:WaitForChild(player.Name.."'s BlueCar").WheelBL:FindFirstChildWhichIsA("SpringConstraint", true)

local wheelHingeR = workspace:WaitForChild(player.Name.."'s BlueCar").WheelFR:FindFirstChildWhichIsA("HingeConstraint", true)
local wheelHingeL = workspace:WaitForChild(player.Name.."'s BlueCar").WheelFL:FindFirstChildWhichIsA("HingeConstraint", true)
